...
from DiseaseClassifier.pipeline.stage_03_training import ModelTrainingPipeline
from DiseaseClassifier.pipeline.stage_04_evaluation import EvaluationPipeline
